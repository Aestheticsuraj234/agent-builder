    ...
    <div className="flex flex-1 flex-col p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm">
          Connect MCP servers. Their tools show up in Agent settings.
        </p>
      </div>
      ...
      <div className="mb-8 max-w-lg space-y-4 rounded-2xl border border-border p-4">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleCreate} disabled={!name || !url || createConnection.isPending}>
            Save connection
          </Button>
        </div>
            ...
            >
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => toggleConnection.mutate({ id: c.id, enabled: !c.enabled })}
                >
